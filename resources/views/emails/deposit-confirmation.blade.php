...
<title>Xác nhận đặt cọc – {{ $reservation->code }}</title>
<style type="text/css">
...
@media only screen and (max-width: 600px) {
    ...
    .deposit-amount { font-size: 22px !important; }
}
</style>
</head>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#1A1A18; border:1px solid #2E2E2A;">
    ...
    <tr>
        <td class="eb" style="padding:36px 40px 24px;">
            ...
            <p style="font-size:13px; color:#8C7E6A; line-height:1.8; margin:0;">
                Sapiens House xin xác nhận đã nhận được khoản đặt cọc cho booking của Quý khách.
            </p>
        </td>
    </tr>
    ...
    <tr>
        <td class="ebs" style="padding:0 40px 24px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                   style="background-color:#0F0F0D; border:1px solid #B8925A; text-align:center;">
                <tr>
                    <td style="padding:24px 20px;">
                        <p style="font-size:10px; color:#8C7E6A; letter-spacing:2px; text-transform:uppercase; margin:0 0 10px;">
                            Số tiền đặt cọc
                        </p>
                        <p class="deposit-amount" style="font-size:28px; color:#B8925A; font-weight:700; letter-spacing:1px; margin:0;">
                            {{ number_format($depositAmount) }} VNĐ
                        </p>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="padding:16px 20px;">
                        <p style="font-size:12px; color:#8C7E6A; line-height:1.9; margin:0;">
                            Khoản đặt cọc này sẽ được <strong style="color:#C9B99A;">khấu trừ trực tiếp vào hóa đơn thanh toán</strong>
    ...
    <tr>
        <td class="ebs" style="padding:0 40px 36px;">
            <p style="font-size:13px; color:#8C7E6A; line-height:1.8; margin:0;">
                Cảm ơn Quý khách đã lựa chọn Sapiens House. Chúng tôi rất mong được đón tiếp Quý khách.
            </p>
